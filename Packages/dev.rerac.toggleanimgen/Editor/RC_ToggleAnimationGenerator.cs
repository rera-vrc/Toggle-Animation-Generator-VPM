...
public class RC_ToggleAnimationGenerator : EditorWindow
{
    ...
    private void OnGUI()
    {
        //Texture banner = (Texture)AssetDatabase.LoadAssetAtPath("./Resources/tag.png", typeof(Texture));
        Texture banner = (Texture)Resources.Load("tag", typeof(Texture));
        GUILayout.Box(banner, GUILayout.Width(400), GUILayout.Height(200));
        GUILayout.Space(10);
        ...
        if( avatar!= null)
        {
            ...
            if (GUILayout.Button("Generate", GUILayout.Height(50)))
            {
                ...
                EditorUtility.DisplayDialog("ReraC Toggle Menu Generator", "Successfully Generated", "ok");
            }
        }
